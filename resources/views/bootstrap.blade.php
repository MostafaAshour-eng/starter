...
<header>
    <!-- Navbar -->
    <header class="navbar navbar-expand-md navbar-dark bd-navbar" style="background-color: #6a91d8;">
        ...
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.6)">
            <div class="d-flex justify-content-center align-items-center h-100">
                <div class="text-white">
                    <h1 class="mb-3">Clothing House</h1>
                    <h4 class="mb-3">Clothing Art</h4>
        ...
        <div class="container">
            <div class="row">
                ...
                @foreach ($images as $image)
                    <div class="col-sm-2">
                        <div class="card">
                            <img src="{{ asset('img/' . $image->getFilename()) }}" alt="..." height="250" width="100%">
                            <div class="card-body">
                                <p class="card-text">consectetur adipis</p>
...
<footer
    ...
    style="background-color: rgb(106, 145, 216); width: 100%"
>
    <!-- Grid container -->
